# Tovanix Platform — 业务全景

> 本文档介绍 **Tovanix**(原 NexCore,运营主体 Astrenix Inc.,美国)综合数字基础服务平台的完整业务版图.
> SDK 当前覆盖 **7 个命名空间 / 44 个 v1 公开 endpoint**(收款 + 汇率 + 提币 + 账户 / 能量 / SMTP / 虚拟卡),其余业务通过 [线上文档](https://tovanix.com/docs) + Web 控制台使用.

## 平台定位

**Tovanix** 是面向开发者与中小团队的**综合数字基础服务平台**,把跨境业务全链路所需的高频但难自研能力封装为 API/控制台,让一个开发者也能搭起完整的跨境业务系统.
...
📋 当前通过 [Web 控制台](https://tovanix.com/m/cloudservice) 使用.
...
📋 当前通过 [Web 控制台](https://tovanix.com/m/sms) 使用.
...
📋 当前通过 [Web 控制台](https://tovanix.com/m) 使用.
...
📋 不在本 SDK 内,**直接用 OpenAI 官方 SDK 改 base_url** 即可.详见 [`/docs?module=aiapi`](https://tovanix.com/docs?module=aiapi).
...
| | URL |
|---|---|
| 主站 | https://tovanix.com |
| API 文档 | https://tovanix.com/docs |
| 用户后台 | https://tovanix.com/m |
| API 网关 | https://api.nexcore.io(技术端点,沿用) |
| 邮箱 | `support@tovanix.com` / `security@tovanix.com` |
| 易记品牌 | https://9188.pro |
| 运营主体 | Astrenix Inc.(US) |

## 历史与定位

Tovanix(原 NexCore)自 **2021 年 7 月** 启动,从最初的多链收款单业务出发,5 年间扩展为 **9 个业务模块** 的综合开发者平台.
...
- Tovanix 用户后台「工单」 — 私下技术支持
- `business@tovanix.com` — 商务合作 / 大客户对接

...
本指南给 Tovanix 维护者一步步发布 SDK 到独立公开 GitHub 仓库。

## 一、独立仓库 vs 主仓库 subtree

SDK 目录(`sdk/`)目前是 Tovanix 主仓库的一部分,但**应该单独建公开仓库**便于:
...
**Description**: `Official multi-language SDK for Tovanix platform (formerly NexCore) — Payment / Energy / SMTP / AI APIs.`
...
3. Tovanix 用户后台 / 工单可关联 SDK GitHub Issues
